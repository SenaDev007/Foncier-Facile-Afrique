          ...
          {items.map((item, i) => {
            ...
            return (
              <div
                ...
                className="absolute w-[280px] h-[360px] md:w-[300px] md:h-[400px]"
                style={{
              ...
              >
                <div className="relative w-full h-full rounded-lg shadow-2xl overflow-hidden group border border-border bg-card/70 backdrop-blur-lg">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/80 to-transparent text-white">
                    <h2 className="text-lg md:text-xl font-bold">{item.common}</h2>
                    <em className="text-xs md:text-sm italic opacity-80">{item.binomial}</em>
                    <p className="text-[11px] md:text-xs mt-2 opacity-70">Photo: {item.photo.by}</p>
                  </div>
                </div>
              </div>
            )
